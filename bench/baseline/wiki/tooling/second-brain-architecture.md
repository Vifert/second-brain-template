...
- **Mira Okafor's second brain**, Obsidian + Claude Code at `a benchmark copy`, on the architecture Vifert designed and built. It serves four jobs: retrieval, idea dump, daily updates, and shared working context.
...
flowchart LR
  ...
  subgraph n27["Guards — nothing ships unchecked"]
    ...
    n31["tools/DEFECTS.md<br>D01–D78 inherited, each<br>with a guard in code"]
...
and everything that keeps it honest — the defect discipline and its 77 guarded
